...
import (
	...
	authService "github.com/grevian/GoGame/auth_service/service"
)

func main() {
	var (
		listenAddr        = flag.String("listen-addr", "0.0.0.0:443", "gRPC Authorization server address to listen on")
